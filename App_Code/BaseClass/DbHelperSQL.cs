...
using System.Collections.Generic;
	...
	public abstract class DbHelperSQL
	{
        ...
        public static string connectionString = ConfigurationManager.ConnectionStrings["SperConnectionString1"].ToString();//PubConstant.ConnectionString; //如果要换数据库，你可以参考SysManage       		
		public DbHelperSQL()
		{              
        }
