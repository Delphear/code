...
<li><A href="book.aspx" target="main_right">留言薄</A></li>
    ...
    <DIV class=guidecollapse id=m08d onclick=c(m08)>系统功能</DIV>
  <DIV class=guide id=m08 style="display: none">
  <UL>
<li><A href="yhgl.aspx" target="main_right">用户管理</A></li>
<li><A href="nbtzgl.aspx" target="main_right">内部通知管理</A></li>
<li><A href="jcsjgl.aspx" target="main_right">基础数据管理</A></li>
  </UL></DIV>
