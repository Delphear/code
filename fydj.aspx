<%@ Page Language="C#" validateRequest="false"  EnableEventValidation="false" AutoEventWireup="true"  CodeFile="fydj.aspx.cs" Inherits="fydj" %>
<%@ Register
...
width="100%">
  ...
  <TR class=tdbg align =center> 
    ...
    <TD align =left class="style1" colspan="5">
      ...
      <asp:DropDownList ID="ddlDepart" runat="server">
        ...
        <asp:TextBox ID="txtJieDao" runat="server" Width="160px"></asp:TextBox>
                                            <asp:DropDownList ID="ddlClass" runat="server">
                                            </asp:DropDownList>
        <asp:TextBox ID="txtXiaoQu" runat="server" Width="220px"></asp:TextBox>
  ...
  <TR class=tdbg align =center> 
    ...
    <TD align =left class="style1">
        一梯几户</TD>
    <TD align =left class="style1">
        <asp:TextBox ID="TextBox7" runat="server" Width="49px" MaxLength="3"></asp:TextBox>
        朝向<asp:DropDownList ID="DropDownList11" runat="server">
            <asp:ListItem>东</asp:ListItem>
            <asp:ListItem Selected>南</asp:ListItem>
  ...
  <TR class=tdbg align =center> 
    ...
    <TD align =left class="style1">
        <asp:TextBox ID="TextBox8" runat="server" Width="83px" MaxLength="10" 
