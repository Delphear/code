<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wdcjfy.aspx.cs" Inherits="wdcjfy" %>
...
width="100%" >
  ...
  <TD style="width: 6%">房源编号</TD>
    <TD style="width: 20%">区域/街道</TD>
    <TD style="width: 20%">小区</TD>
    <TD style="width: 10%">户型</TD>
    <TD style="width: 10%">建筑面积</TD>
    <TD style="width: 7%">楼层情况</TD>
    <TD style="width: 7%">价格</TD>
    <TD style="width: 10%">售租形式</TD>

    </TR>
<asp:Repeater ID="Repeater1" runat="server">
  <ItemTemplate>
  <TR class=tdbg align =center onmouseover="this.style.backgroundColor='#b0d0f3'" onmouseout="this.style.backgroundColor='#e6eff8'" onclick=" J.dialog.get({ id: 'sblb', title: '房源详细信息', page: 'Wfyxx.aspx?id=<%# DataBinder.Eval(Container.DataItem," ID ") %>' ,width: 900, height: 545, nofoot: true, nohead: true,cover: true });">
