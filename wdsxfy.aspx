<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wdsxfy.aspx.cs" Inherits="wdsxfy" %>
...
<asp:Repeater ID="Repeater1" runat="server">
  ...
  <TR class=tdbg align =center onmouseover="this.style.backgroundColor='#b0d0f3'" onmouseout="this.style.backgroundColor='#e6eff8'" >
    ...
    <TD><%# DataBinder.Eval(Container.DataItem, " 售租形式")%></TD>
       <TD><asp:LinkButton ID="BtnDel" runat="server" CommandName='<%# DataBinder.Eval(Container.DataItem," ID ") %>' OnCommand="BtnDel_Click" OnClientClick="return confirm('您确定要删除该失效房源吗?数据不可恢复!');" Font-Underline="False" ForeColor="red" >【删除】</asp:LinkButton></TD>
